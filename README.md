...
Здесь Вы также найдете файл: `lotsofweЬ.pcapng`, `wrongdissector.pcapng`, `http_google.pcapng` которые упоминаются в книге "Анализ пакетов. Практическое руководство по исаользованию Wire Shark и tcpdump для решения реальных проблем в локальных сетях." автор: Крис Сандерс. 
